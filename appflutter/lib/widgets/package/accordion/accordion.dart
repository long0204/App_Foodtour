...
import 'accordion_controller.dart';
export 'accordion_section.dart';
export 'accordion_controller.dart';

/// The container list for all accordion sections.
class MyAccordion extends StatelessWidget with CommonParams {
  ...
  MyAccordion({
    ...
    String? accordionId,
    // this.gradient = const [Colors.amber, Colors.amber],
  }) : super(key: key) {
